...
public class MultibindingTest {
  ...
  @Test public void nestedKeyMap() {
    assertThat(multibindingComponent.nestedKeyMap())
        .containsExactly(
                MultibindingTestContext.nestedWrappedKey(Integer.class), "integer", MultibindingTestContext.nestedWrappedKey(Long.class), "long");
  }

  @Test
  public void unwrappedAnnotationKeyMap() {
    assertThat(multibindingComponent.unwrappedAnnotationKeyMap())
        .containsExactly(MultibindingTestContext.testStringKey("foo\n"), "foo annotation");
  }
  ...
  public void wrappedAnnotationKeyMap() {
    ...
    assertThat(multibindingComponent.wrappedAnnotationKeyMap())
        .containsExactly(
                MultibindingTestContext.testWrappedAnnotationKey(
                        MultibindingTestContext.testStringKey("foo"), new int[] {1, 2, 3}, new ClassKey[] {}, classes),
