...
public final class ComplexMapKeysInDifferentOrderTest {
  ...
  @Test
  public void test() {
    Map<ComplexMapKeysInDifferentOrderTestContext.ComplexMapKey, Integer> map =
        DaggerComplexMapKeysInDifferentOrderTestContext_TestComponent.create().map();
    assertThat(map.get(mapKey(1, 2))).isEqualTo(3);
    assertThat(map.get(mapKey(5, 4))).isEqualTo(6);
  }

  @AutoAnnotation
  static ComplexMapKeysInDifferentOrderTestContext.ComplexMapKey mapKey(int i, int j) {
